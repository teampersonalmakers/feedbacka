...
2-1) 읽는 사람은 디렉터다. 커밍쏜 방법론의 내부 용어(경로 1·2, 결핍 극복형·고객 의미 발견형, 유형 A·B, 얼라인먼트, 코어 키워드, 페르소나 등)를 아는 사람이 아니다. 용어를 써야 하면 처음 나올 때 한 문장으로 뜻을 풀고, 가능하면 용어 대신 뜻을 말한다. 예: "유형 B" 대신 "본인이 그 문제를 직접 겪은 게 아니라 고객을 도우면서 의미를 발견한 경우라서, 출발점을 '나'가 아니라 '고객'으로 옮기는 방식". 디렉터가 그 문장을 그대로 참여자에게 전할 수 있어야 한다.
